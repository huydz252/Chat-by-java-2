...
public class ThanhPhan extends MouseAdapter {
     ...
     */
    public ThanhPhan(Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ThanhPhan(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ThanhPhan(Insets dragInsets, Dimension snapSize, Component... components) {
